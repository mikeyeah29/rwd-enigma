...
<section class="media-section" id="media">
    <div class="container">
        ...
        <div class="row d-flex align-items-center">
            <div class="col-md-6">
                <div class="heading-group">
                    <p class="font-display text-white">Media</p>
                    <h2 class="hdln-2 text-white">As Seen On</h2>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="parallax" data-rellax-speed="1" data-rellax-percentage="0.5">
                    ...
                    <div class="iframe-wrapper">
                        <iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=1234567890" frameborder="0" allowfullscreen></iframe>
                    </div>
        ...
        <div class="row justify-content-center d-flex">
            <div class="col-md-10">
                 <p class="text-white">Emiliana is a best selling author, psychotherapist, and Tv personality who regularly appears on television and radio giving advice, debating about love, sex and the trials and tribulations of being in a relationship. Emiliana has made countless appearances on live television and radio, as well as being featured in numerous newspapers, magazines, and online articles including her own newspaper column on love and dating. She made her debut television appearance on ITV’s This Morning show and more recent years, Good Morning Britain. Emiliana is the international go to expert for any matters that deal with love, relationships, and sex.</p>
            </div>
        </div> -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <a href="media.html" class="rwd-btn rwd-btn--accent mt-3">View All Media</a>
            </div>
        </div> -->
